...
class AsignarLiderMedUseCaseTest {
    ...
    private List<DomainEvent> eventsLiderAsignado() {
        ...
        co.com.sofkau.operacion.entitys.liderO.Lider lider = new Lider(co.com.sofkau.operacion.entitys.liderO.LiderId.of("123"), new Nombre("Jhon Stiven"), new Nacionalidad("Colombiano"),
                new Edad(35), new Rango("General"), new Genero('H'));
        Set<co.com.sofkau.operacion.entitys.Victima.Victima> victimas = new HashSet<>();
        co.com.sofkau.operacion.entitys.Victima.Victima victima = new Victima(VictimaId.of("45"), new Nombre("Juan Fernando castaño"),
