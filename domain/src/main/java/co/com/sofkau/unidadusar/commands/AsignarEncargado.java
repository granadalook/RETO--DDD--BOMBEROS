...
public class AsignarEncargado extends Command {
    ...
    public AsignarEncargado(UnidadUsarId unidadUsarId, RescatistaId rescatistaId, Nombre nombre, Nacionalidad nacionalidad, Edad edad, Rango rango, Genero genero) {
