...
public class EncargadoAsignado extends DomainEvent {
    ...
    public EncargadoAsignado(RescatistaId rescatistaId, Nombre nombre, Nacionalidad nacionalidad, Edad edad, Rango rango, Genero genero) {
        super("sofkau.unidadusar.events.encargadoasignado");
